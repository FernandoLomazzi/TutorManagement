...
public class Student {
	...
	public Student(String name, String surname, String address, String phoneNumber, LocalDate birthday, String socialMedia, String description, EducationLevel lvl) {
		this.name = name;
